...
export default function Login() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (email === "admin" && password === "admin") {
      ...
      setError("Invalid credentials. Use 'admin' as login and password.");
    }
  };
      ...
      <div className="pt-40 pb-20 px-4 flex items-center justify-center">
        <div className="glass-card w-full max-w-md p-10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2">Sign in to continue to Engineering Hub</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            Don't have an account? <Link href="/signup" className="text-indigo-400 hover:underline">Sign up for free</Link>
          </p>
        </div>
      </div>
    </main>
